...
locations.first.vehicles = Vehicle.create([
  ...
  { color: "grey", style: "convertible", ticket_no: 102, space: "4", status: "transit" },
...
locations[1].vehicles = Vehicle.create([
  ...
  { color: "white", style: "sedan", ticket_no: 237, space: "3B7", status: "transit" },
]) 
 
locations[2].vehicles = Vehicle.create([
  { color: "blue", style: "suv", ticket_no: 521, space: "A8", status: "parked" },
  { color: "green", style: "sedan", ticket_no: 522, space: "C4", status: "transit" },
  { color: "yellow", style: "coupe", ticket_no: 523, space: "tB3", status: "transit" },
